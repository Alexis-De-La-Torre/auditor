...
require('./routes/registrar-auditoria')(app, db, ensureLogin, sendEmail, authMsg)
require('./routes/analizar-auditoria')(app, db, ensureLogin, sendEmail, authMsg)
require('./routes/resolver-auditoria')(app, db, ensureLogin, sendEmail, authMsg)
require('./routes/revisar-auditoria')(app, db, ensureLogin, sendEmail, authMsg)
require('./routes/finalizar-auditoria')(app, db, ensureLogin, sendEmail, authMsg)
